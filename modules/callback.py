...
from helpers import LOGGER, SmartButtons, edit_message
...
def build_back_markup():
    sb = SmartButtons()
    sb.button("◀️ Back", callback_data="back_to_start", style="primary")
...
async def callback_handler(event):
    ...
    if data == b"about":
        ...
        await edit_message(event.chat_id, event.message_id, text, link_preview=False, buttons=build_back_markup())

    elif data == b"policy":
        text = (
            "**📜 Privacy Policy for MOBIUS CLOUD**\n\n"
            "Welcome to **MOBIUS CLOUD** Bot. By using our services, you agree to this privacy policy.\n\n"
            ...
            "   • **Service Enhancement:** To provide and improve **MOBIUS CLOUD.**\n"
            ...
            "Thank you for using **MOBIUS CLOUD**. We prioritize your privacy and security."
        )
        await edit_message(event.chat_id, event.message_id, text, link_preview=False, buttons=build_back_markup())

    elif data == b"main_menu":
        text = (
            "**🤖 MOBIUS CLOUD Commands**\n\n"
            "**Basic Commands:**\n"
        ...
        await edit_message(event.chat_id, event.message_id, text, link_preview=False, buttons=build_start_markup())
